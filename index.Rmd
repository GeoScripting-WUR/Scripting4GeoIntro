...
1330 to 1430  | [Course introduction, planning and teams selection (PC37, first floor, GAIA)](https://geoscripting-wur.github.io/Scripting4GeoIntro/GeoScripting_Concept_Intro.html#1):
...
In the morning you can work from home or can come to the PC37 and PC35 room, GAIA.

You need to have `Rstudio Desktop` (Free) and `R` (Free) installed (already available in the PClab). 

For more information see [Geo-scripting system set-up](http://geoscripting-wur.github.io/system_setup/)
...
**Try it out!** We will explain how this can be used during this course at 1330 today in PC37.
...
- submit via BlackBoard via our Script Review Center. See deadline description there.

## Assessment - and evaluation criteria for the excercise

It needs to work (yes/no) when we copy it to our R environment and run. 
