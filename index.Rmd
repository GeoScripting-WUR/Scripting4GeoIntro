...
Here is an example of how you can create a map in R. It is a function do get *public* data from anywhere in the world. See help of the `getData` function in the `raster` package.
