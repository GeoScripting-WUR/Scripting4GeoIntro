...
- Self-study in the morning
- 1330: Course introduction, planning, selection of the teams (PC38, GAIA)
...
You need to have Rstudio Desktop (Free) and R (Free) installed on your laptop (see http://www.rstudio.com/products/rstudio/download/ )
...
- Refreshing R skills and assessing scripting skills
...
- Send the script to another team and let them test it! Does it work yes/no? Before send it to us.
- keep it simple (!) e.g. just plot the adminstrative boundaries
- The function should accept `country` and `level` as input arguments
- Filename: *lastnamefirstname.R* (of the team members)
