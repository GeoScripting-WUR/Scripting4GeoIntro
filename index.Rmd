...
In future tutorials we will show you how you can read and write different spatial objects (e.g. vector and raster files).
...
We load the administrative boundaries of the Philippines, using the `sf` library, to which you will be introduced more in-depth in a future tutorial:
