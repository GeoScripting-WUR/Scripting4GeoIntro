...
Good morning, and welcome to the Geoscripting course! As a student enrolled in the course at Wageningen University, here is what you will do today:
...
- 14:00: 
    ...
    - Do the excercise at the bottom of this page, with submission deadline today.
...
Then you can use relative paths to load your data, for example:

```{r, eval=FALSE}
# Path to a file "my-table.csv" in the directory "data", relative to your script file
...
Vectors of numbers are called **numeric vectors**, and matrices of numbers are **numeric matrices**. Arithmetics with matrices work the same way as with vectors, i.e. element-wise. So a multiplication between two matrices is element-wise value multiplication, *not* mathematical matrix multiplication.
...
Try to understand the code below, and let us know if you have questions. Feel free to use this code as an example and use this for the excercise below.
...
- Use the script review center in BlackBoard to submit your script by **17:15**.
...
```{block, type="alert alert-info"}
**Protip**: Alternatively, you can also upload your solution as a secret [GitHub Gist](https://gist.github.com/) and then paste a link to it on BlackBoard.
```
