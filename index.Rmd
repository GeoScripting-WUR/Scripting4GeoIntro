...
During the morning session read through this tutorial but focus on the code examples from Introduction to R onwards.

See [Getting Started With R](#gettingstarted)).
...
Learn the basics, and go to [Try R](http://tryr.codeschool.com/). 
