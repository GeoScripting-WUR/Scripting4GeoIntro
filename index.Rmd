...
# Excercise 1: Develop a function to create a spatial map
...
- All code requires comments - explaining its function
...
The rubric for this excercise can be found here: [Generic Rubric](https://docs.google.com/document/d/1wdqcrqh4Bt-tNwhEFRa4esq7ozwo36tfOjGmbBTK5B4/edit?usp=sharing)
...
You will need to give the team you are reviewing feedback on their exercise solution before 11:00 the next day (use the review team generator Shiny app to see which team). Then clone the repository of the team you have to review to your computer and test it. Add an issue to their project, write your review and give points according to the rubrics. Make sure to mention your team name in the review.
