...
In the morning you can work from home or can come to the PC8020 and PC8045 rooms in ORION. You need to have *RStudio Desktop* (Free) and *R* (Free) installed (already available in the PC lab). For more information about *R* and *RStudio* installation: see [Geo-scripting system set-up](http://geoscripting-wur.github.io/system_setup/)
...
- Use the script review center to submit your "documented script" in time before 17.15.
