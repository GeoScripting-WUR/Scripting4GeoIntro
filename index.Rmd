...
- Submission: See description in BlackBoard - follow the file naming precisely.
...
Use this rubric and fill in the form as a guideline and copy "as text" (not as a document! or attachement) with the blackboard box.
