...
* Experts from companies, research institute (e.g. , [WENR](https://www.wur.nl/nl/Onderzoek-Resultaten/Onderzoeksinstituten/Environmental-Research.htm)) and 
...
- DataCamp website: challenges
    ...
    - Which course would you like to have as a challenge?
- Script reviewing can be done on an individual basis, via script review center (bonus points)
- Feedback on course content via Github (bonus points)
- Self-study
